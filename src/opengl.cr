...
lib LibGL
  ...
  fun draw_range_elements = glDrawRangeElements(mode : GLenum, start : UInt32, _end : UInt32, count : SizeInt, type : Enum, indices : Void*) : Void
